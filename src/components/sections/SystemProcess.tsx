...
const SystemProcess = () => {
  const steps = [
    { icon: Crosshair, number: "1", title: "Klarer Fokus", description: "Zielgruppe, Angebot, Botschaft" },
    { icon: FileText, number: "2", title: "Content mit Funktion", description: "Nicht für Likes – sondern für Entscheidungen" },
    { icon: Link2, number: "3", title: "Lead-System", description: "DM, Landingpage oder Terminbuchung" },
    { icon: Handshake, number: "4", title: "Übergabe an Abschluss", description: "Kein Chaos, kein Nachfassen ins Leere" }
  ];
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-4 gap-6 relative">
            ...
            <motion.div
              ...
              className="hidden md:block absolute top-12 left-[12%] right-[12%] h-0.5 bg-gradient-to-r from-primary/20 via-primary/40 to-primary/20 origin-left"
            />
            
            <StaggerContainer className="grid md:grid-cols-4 gap-6 col-span-full" staggerDelay={0.18} delay={0.2}>
