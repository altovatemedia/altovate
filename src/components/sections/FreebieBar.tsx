    ...
    <>
      ...
      >
        <button 
          ...
          className="group flex items-center justify-center gap-2 md:gap-3 text-xs md:text-sm font-medium bg-card hover:scale-[1.01] transition-all duration-200 px-4 py-2.5 md:px-6 md:py-3 rounded-xl md:rounded-full shadow-card border border-border/50 w-full"
        >
          <span className="text-foreground text-center leading-tight">
