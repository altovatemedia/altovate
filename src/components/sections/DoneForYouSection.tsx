    ...
    <section className="py-24 bg-[#1a1a1a] relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Description */}
          <div className="mb-12">
            <p className="text-white/80 text-lg leading-relaxed text-center max-w-3xl mx-auto mb-8">
          ...
          {/* Services Grid */}
          <div className="bg-white/5 rounded-2xl border border-white/10 p-8 md:p-12 mb-12">
          ...
          <div className="text-center">
            <div className="inline-block bg-white/10 rounded-full px-6 py-3 mb-6">
              <span className="text-white font-medium">Aktuell ausgebucht</span>
            </div>
