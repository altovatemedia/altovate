  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Diese KI-Tools nutze ich täglich, um mit der Effizienz von 10 A-Playern zu arbeiten. Motion Design, Diktiersoftware, No-Code – ehrliche Empfehlungen aus der Praxis."
        />
      </Helmet>
        ...
        <section className="relative py-20 md:py-28 overflow-hidden">
          ...
          <div className="container mx-auto px-6 relative z-10 max-w-4xl text-center">
            ...
            <p className="finom-lead max-w-2xl mx-auto">
              Diese Tools nutze ich täglich, um mit der Effizienz von 10 A-Playern zu arbeiten. Kein Sponsoring, keine bezahlte Werbung – nur ehrliche Empfehlungen aus meinem Alltag.
            </p>
          </div>
        </section>
        ...
        <section className="pb-20">
          <div className="container mx-auto px-6 max-w-3xl text-center">
            <p className="text-muted-foreground text-sm leading-relaxed">
              <strong className="text-foreground/70">Transparenzhinweis:</strong> Einige der Links auf dieser Seite sind Affiliate-Links. Wenn du ein Tool über meinen Link testest, erhalte ich ggf. eine kleine Provision – für dich entstehen keine Mehrkosten. Ich empfehle ausschließlich Tools, die ich selbst aktiv nutze.
            </p>
          </div>
        </section>
      </main>
