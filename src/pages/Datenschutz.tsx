        ...
        <div className="container mx-auto px-6">
          <div className="max-w-[720px] mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-left">
              <p className="text-[#09002C]/80 mb-8 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#09002C] mb-4">1. Verantwortlicher</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#09002C] mb-4">2. Erhebung und Speicherung personenbezogener Daten</h2>
                <p className="text-[#09002C]/80 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#09002C] mb-4">3. Hosting und Infrastruktur</h2>
                <p className="text-[#09002C]/80 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#09002C] mb-4">4. Einsatz von Cookies</h2>
                <p className="text-[#09002C]/80 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#09002C] mb-4">5. Analytische Dienste</h2>
                <p className="text-[#09002C]/80 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#09002C] mb-4">6. Marketing-Tools / Pixel</h2>
                <ul className="text-[#09002C]/80 leading-relaxed list-disc list-inside space-y-2">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#09002C] mb-4">7. Social Media Plugins</h2>
                <p className="text-[#09002C]/80 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#09002C] mb-4">8. Eingesetzte Drittanbieter-Tools</h2>
                <ul className="text-[#09002C]/80 leading-relaxed list-disc list-inside space-y-2">
                ...
                <p className="text-[#09002C]/80 leading-relaxed mt-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#09002C] mb-4">9. Rechte der Nutzer</h2>
                <p className="text-[#09002C]/80 leading-relaxed mb-4">Sie haben jederzeit das Recht auf:</p>
                <ul className="text-[#09002C]/80 leading-relaxed list-disc list-inside space-y-2">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#09002C] mb-4">10. Speicherdauer</h2>
                <p className="text-[#09002C]/80 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold text-[#09002C] mb-4">11. Beschwerderecht</h2>
                <p className="text-[#09002C]/80 leading-relaxed">
